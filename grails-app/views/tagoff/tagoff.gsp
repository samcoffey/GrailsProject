...
<html>
	...
	<body>
		...
		<g:link mapping = "home" ><img src="${resource(dir: 'images', file: 'button4.jpg')}" class="img-responsive "/></g:link><hr>
		<img src="${resource(dir: 'images', file: 'profile1.jpg')}" class="img-responsive "/>
